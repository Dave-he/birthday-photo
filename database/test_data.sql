-- ==========================================
-- Birthday Photo App - Test Data
-- ==========================================
-- This file contains sample data for testing and development
-- Run this after schema.sql and policy.sql
...
INSERT INTO settings (
  ...
  is_snowing, 
  greeting_title,
  auto_mode_cycle_enabled,
  mode_cycle_min_seconds,
  mode_cycle_max_seconds,
  low_quality_mode,
  particle_multiplier
)
SELECT 
...
VALUES 
  -- Christmas Scene Photos
  (
    'https://images.unsplash.com/photo-1543589077-47d81606c1bf?auto=format&fit=crop&w=800', 
    'Snowy Morning', 
  ...
  (
    'https://images.unsplash.com/photo-1512474932049-782abb8be2e9?auto=format&fit=crop&w=800', 
    'Christmas Tree', 
  ...
  (
    'https://images.unsplash.com/photo-1576618148400-f54bed99fcfd?auto=format&fit=crop&w=800', 
    'Gifts!', 
  ...
  -- Birthday Scene Photos
  (
    'https://images.unsplash.com/photo-1530103862676-de3c9da59af7?auto=format&fit=crop&w=800', 
    'Birthday Cake', 
  ...
  (
    'https://images.unsplash.com/photo-1513151233558-d860c5398176?auto=format&fit=crop&w=800', 
    'Party Time', 
